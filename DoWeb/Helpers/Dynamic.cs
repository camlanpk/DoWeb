...
namespace Helpers.linq.Dynamic
{
    public static class DynamicQueryable
    {
        ...
        public static double? SumEx<TSource>(this IEnumerable<TSource> source, Func<TSource, double?> selector)
        {
            if (source?.Count() == 0)
                return (double?)null;
        ...
        public static bool Like(this string s, string pattern)
        {
            ...
            pattern = ".*" + pattern.ConvertToUnsign() + ".*";

            return Regex.IsMatch(s.ConvertToUnsign(), pattern);
        }
        ...
        public static bool EqualsNotMatchCase(this string s, string pattern)
        {
            if ((!string.IsNullOrEmpty(s) && string.IsNullOrEmpty(pattern)) || (string.IsNullOrEmpty(s) && !string.IsNullOrEmpty(pattern)))
                return false;
            return (s + "").ToLowerInvariant() == (pattern + "").ToLowerInvariant();
        }
    }
